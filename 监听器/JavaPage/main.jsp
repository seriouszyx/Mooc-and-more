...
<div class="banner" id="home">
    ...
    <div class="header">
        <div class="navigation">
            ...
            <ul class="navig">
                <li><a href="index.html" class="scroll"><%=user  %>
                </a><span>|</span></li>
...
<div class="free wow bounce" data-wow-delay="0.1s">
    <div class="container">
        <div class="free-main">
            ...
            <p><sup><img src="images/quote-1.png" alt=""></sup> Etiam in porttitor risus. Curabitur non diam id lacus
                facilisis consequat. Integer pulvinar ex nunc, id porttitor orci sollicitudin id. Morbi vitae sodales
                arcu, vel maximus neque. Nullam a faucibus justo sit. <sub><img src="images/quote-2.png" alt=""></sub>
            </p>
        </div>
    </div>
</div>
        ...
        <div class="blog-main">
            <div class="col-md-4 blog-left">
                <div class="blog-one wow bounceInLeft" data-wow-delay="0.4s">
                    ...
                    <h3>RESUME</h3>
                    <p>Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from
                        45 BC, making it over 2000</p>
                </div>
            </div>
            <div class="col-md-4 blog-left">
                <div class="blog-one wow bounce" data-wow-delay="0.1s">
                    ...
                    <h3>BLOG</h3>
                    <p>Random text. It has roots in a piece of classical Latin literature from 45 BC, making it over
                        2000 </p>
                </div>
            </div>
            <div class="col-md-4 blog-left active">
                <div class="blog-one wow bounceInRight" data-wow-delay="0.4s">
                    ...
                    <h3>OTHERS</h3>
                    <p>Lorem Ipsum is not simply random text. Latin literature from 45 BC, making it over 2000 years
                        old</p>
                </div>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="contact-main">
            ...
            <div class="col-md-6 contact-left wow bounceInRight" data-wow-delay="0.4s">
                ...
                <div class="contact-textarea">
                    <textarea value="Your question" onfocus="this.value = '';"
                              onblur="if (this.value == '') {this.value = 'Your question';}">Your question</textarea>
                </div>
